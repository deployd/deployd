...
* Make it possible to further extend an express or socketIo server.
*
* The attached server instance consists of a handleRequest function which is a express middleware
*
* Options:
*
