...
function Db(options) {
  this.options = options;
  this.connectionString = this.options.connectionString || "mongodb://" + (this.options.credentials ? this.options.credentials.username + ":" + this.options.credentials.password + "@" : "") + this.options.host + ":" + this.options.port + "/" + this.options.name;
}
...
function getConnection(db) {
  if (db.Db) return Q(db.Db); // reuse connection
