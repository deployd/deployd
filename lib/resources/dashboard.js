...
function Dashboard(name, options) {
  // internal resource
  this.internal = true;
  this.dpdjs_url_namespace = options.dpdjs_url_namespace;
...
Dashboard.prototype.render = function(ctx) {
  ...
  async.parallel({
    ...
    options.dpdjs_url_namespace = self.dpdjs_url_namespace + 'dpd.js';
    options.dashboard_url_namespace = self.path;
    ...
    try {
      var rendered = results.layout({
        context: context,
        render: render,
        scripts: options.scripts || [],
        css: options.css || null,
        dpdjs_url_namespace: options.dpdjs_url_namespace,
        dashboard_url_namespace: options.dashboard_url_namespace || '/admin/'
      });
