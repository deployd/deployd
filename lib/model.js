...
Model = module.exports = emitter.spawn({
  ...
  defineRoutes: function() {
    ...
    app.all('/' + (this.plugin || 'graph') + '/' + collection, function(req, res) {
      var query = req.params
        , action = methodMap[req.method]
      ;
...
module.exports.spawn = function(model) {
  ...
  if(model && model.collection && !_models[instance.collection]) {
    _models[instance.collection] = instance;
    instance.updateSettings();
    instance.defineRoutes();
  }
  return instance;
};